...
| 6 | **真·2mA 待机省电** | 5 分钟自动待机：关 WiFi 无线电 + CPU 轻睡眠 + 待机页不刷新 → 待机仅 ~2mA，续航 25~50 天 |
...
**AI 工具 · 智能硬件 · 独立开发**，共同爱好者的聚集地。本项目的想法、踩坑记录、固件更新第一时间在群里同步，欢迎来聊：

<p align="center">
  <img src="docs/images/aigroup.jpg" width="300" alt="AI万物社 交流群二维码">
</p>

> 🕐 群二维码 7 天有效，过期请提 Issue 获取新码。
